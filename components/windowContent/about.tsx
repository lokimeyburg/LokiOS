...
Founded a new team thanks to a strategic paper I got alignment on. Partnered with research, design, engineering and marketing to create a vision and strategy for building an intelligent collaborative platform with AI agents and automation.
Project Neptune: Released a new automations experience in Teams. Showcased at Build. Grew # of users running automations in Teams by 29% YoY. Running 392M workflows per week. Used by 98% of the S500 customers.AI workflows with Copilot Actions integration shown at Build Conference.
Natural language to workflow creation required a new AI model.
Collaborative effort across Teams, SP and Power Automate.
